  ...
  <body>
    ...
    <div class="container">
      ...
      <span>
            ...
            <ol>
                <li>Okazać dokument tożsamości, obcokrajowcy okazują dodatkowo kartę stałego (czasowego) pobytu lub inny dokument potwierdzający stały lub tymczasowy adres zamieszkania na terenie Rzeczypospolitej Polski.</li>
                <li>Zapoznać się z Regulaminem biblioteki.</li>
                <li>Wypełnić kartę zapisu i zobowiązać się podpisem do przestrzegania Regulaminu. Zobowiązania osób niepełnoletnich podpisują rodzice lub opiekunowie prawni po okazaniu dokumentu tożsamości.</li>
            </ol>
