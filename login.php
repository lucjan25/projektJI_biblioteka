...
<html lang="en">
  ...
  <body>
    ...
    <?php 
      if (isset($_GET["err"])){
        echo "<span>Podano błędne dane</span>";
      }
    ?>
      <form name="f" action = "authentication.php" method = "POST">
        ...
        <button type="submit" class="btn btn-info btn-block btn-round">Zaloguj się</button>
      </form>
    </div>
